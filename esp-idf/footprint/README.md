...
```text
esp-idf/footprint/build-footprint-report.json
```
...
```bash
cd ../..
./tools/measure_esp_idf_footprint.py --target esp32 --skip-build --monitor-log esp-idf/footprint/footprint-monitor.log
```
