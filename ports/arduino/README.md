...
Preview `0.2.1`. Use for evaluation or controlled pilots until your product has passed hardware, TLS, offline queue, flush, retry, and power-cycle validation on the target ESP32 board.

`0.2.1` is the version published in `library.properties` and reported by events
