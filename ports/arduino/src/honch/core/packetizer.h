...
typedef enum honch_data_source_mask {
    ...
    HONCH_DATA_SOURCE_COREDUMP = 1u << 3,
    HONCH_DATA_SOURCE_ALL = HONCH_DATA_SOURCE_EVENTS | HONCH_DATA_SOURCE_LOGS |
        HONCH_DATA_SOURCE_DIAGNOSTICS | HONCH_DATA_SOURCE_COREDUMP
