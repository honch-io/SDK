...
- `json/`: JSON ingestion path fixtures for third-party HTTP clients. The valid
  fixtures reuse the same expanded events as the `wire-v2/` fixtures, proving the
  JSON and binary paths produce identical canonical events. See `json/README.md`.
