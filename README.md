...
| --- | --- | --- | --- |
| ESP-IDF | Stable | `0.2.2` | [`ports/esp-idf/`](ports/esp-idf/) |
| C/POSIX | Stable | `0.2.2` | [`ports/posix/`](ports/posix/) |
| MicroPython | Stable | `0.2.2` | [`ports/micropython/`](ports/micropython/) |
| Arduino ESP32 | Preview | `0.2.2` | [`ports/arduino/`](ports/arduino/) |
