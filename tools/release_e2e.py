...
STEPS: tuple[Step, ...] = (
    ...
    step(
        ...
        "local-docs/review-wip.md docs/superpowers/plans/2026-05-21-production-e2e-test-campaign.md || true",
        HOST,
    ...
    step(
        "C core / POSIX",
        "run compact wire migration guards",
        "python3 ports/posix/test/test_cbor_migration.py",
        HOST,
        "15-posix-cbor-migration.txt",
    ...
    step(
        "ESP-IDF",
        "run ESP static migration and footprint tests",
    ...
    step(
        ...
        "HONCH_ARDUINO_HOME=$HONCH_E2E_BUILD_ROOT/arduino-cli "
